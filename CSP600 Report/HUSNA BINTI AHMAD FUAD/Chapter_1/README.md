...
b)	To Evaluate the Accuracy of Geolocation Technology in Finding the Nearest Service Based on User Content Recommendations using Functionality Testing.
